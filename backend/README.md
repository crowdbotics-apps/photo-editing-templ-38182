...
## Project Structure
    ...
    ├── photo_editing_templ_38182  # Django project configurations
...
1. Clone this repo and `cd photo_editing_templ_38182`
...
2. Clone this repo and `cd photo_editing_templ_38182`
